        ...
        <div className="space-y-3">
          <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-4">
            ...
            <p className="mt-1 text-xs text-zinc-500">
              Ahora cada tarjeta puede registrar su propio cambio. La app ya no
              depende solo del último servicio general.
            </p>
              ...
              >
                ...
                <div className="mt-3 grid grid-cols-2 gap-2">
                  ...
                  <div className="rounded-xl bg-black/20 p-3">
                    ...
                    <p className={`mt-1 text-sm font-semibold ${classes.text}`}>
                      {item.nextLabel}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-3 rounded-2xl bg-zinc-950/70 p-3">
                  ...
                  <p className="mt-1 text-sm text-zinc-300">{item.action}</p>
                </div>
